...
from lp_solver.naive_approximation import NaiveNetwork
from lp_solver.utils import get_relu_mask
...
class LinearizedNetwork(NaiveNetwork):
    ...
    def build_model_using_bounds(self, input_domain, intermediate_bounds, n_threads=1):
        ...
        # dummy naive interval propagation dual
        self.last_duals = [torch.zeros_like(self.lower_bounds[idx]) for idx in range(1, len(self.lower_bounds))]
