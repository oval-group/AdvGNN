...
from lp_solver.network_linear_approximation import LinearizedNetwork

from lp_solver.utils import LinearOp, ConvOp, prod, OptimizationTrace, ProxOptimizationTrace, bdot
from lp_solver.utils import BatchLinearOp, BatchConvOp, get_relu_mask, compute_output_padding, create_final_coeffs_slice
from lp_solver.by_layer import ByLayerDecomposition
from lp_solver.by_pairs import ByPairsDecomposition, DualVarSet


class SaddleLP(LinearizedNetwork):

    def __init__(self, layers, store_bounds_progress=-1, store_bounds_primal=False, max_batch=20000, store_duals=False):
        """
        ...
        self.store_bounds_duals = store_duals
    ...
    def init_optimize(self, weights, final_coeffs,
        ...
        if self.store_bounds_duals:
            self.bounds_duals = dual_vars
    ...
    def get_dual_vars(self):
        """
        Return the dual variables that were used in the last bounds computation.
        """
        assert self.store_bounds_duals
        return self.bounds_duals
